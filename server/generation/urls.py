...
urlpatterns = [
    ...
    path('generate_time', views.generate_time, name='generate_time'),  # 异常数据
    ...
    path('current_protocol', views.current_protocol, name='current_protocol'),  # 协议配置
    path('protocol_save', views.protocol_save, name='protocol_save')  # 协议配置
]
